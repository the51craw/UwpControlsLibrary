...

 {
    public sealed partial class MainPage : Page
    {
        ...
        private async void imgClickArea_ImageOpened(object sender, RoutedEventArgs e)
        {
            ...
            // Create all controls:
            Controls.AddStaticImage((int)ControlId.GRAPH, gridControls, 
                new Image[] { imgMrMartin }, new Point(10, 560));

            Controls.AddGraph((int)ControlId.STATICIMAGE, gridControls, 
                new Image[] { imgGraphBackground }, new Point(10, 420), new SolidColorBrush(Color.FromArgb(255, 0, 255, 0)), 2);

            Controls.AddDigitalDisplay((int)ControlId.DIGITAL_DISPLAY, gridControls,
                new Image[] { img0, img1, img2, img3, img4, img5, img6, img7, img8, 
                    img9, imgMinus, imgDot, imgGraphBackground }, new Point(10, 85), 4, 2);

            Controls.AddIndicator((int)ControlId.INDICATOR1, gridControls, 
                new Image[] { imgIndicatorOff, imgIndicatorOn }, new Point(1118, 562));

            Controls.AddIndicator((int)ControlId.INDICATOR2, gridControls, 
                new Image[] { imgIndicatorOff, imgIndicatorOn }, new Point(234, 28));

            Controls.AddKnob((int)ControlId.KNOB, gridControls, 
                new Image[] { imgKnob, imgKnobBackground }, new Point(120, 320), 0, 127, 30, 330);

            Controls.AddVerticalSlider((int)ControlId.VERTICAL_SLIDER, gridControls, 
                new Image[] { imgVerticalSliderBackground, imgVerticalSliderHandle },
                new Rect(270, 134, 121, 399));

            Controls.AddHorizontalSlider((int)ControlId.HORIZONTAL_SLIDER, gridControls, 
                new Image[] { imgHorizontalSliderBackground, imgHorizontalSliderHandle },
                new Rect(427, 424, 399, 121), 0, 127);

            Controls.AddLabel((int)ControlId.LABEL, gridControls, 
                new Rect(274, 80, 1500, 24), "text", 16, TextAlignment.Left);

            Controls.AddJoystick((int)ControlId.JOYSTICK, gridControls,
                new Image[] { imgJoystickBackground, imgStick1, imgStick2, imgStick3, imgJoystickHandle }, 
                new Rect(495, 164, 199, 199), -64, 63, -64, 63);

            Controls.AddImageButton((int)ControlId.BUTTON, gridControls,
                new Image[] { imgImageButtonUpOff, imgImageButtonDownOff, imgImageButtonUpOn, 
                    imgImageButtonDownOn, imgImageButtonHover }, new Point(12, 19));
            ...
            Controls.AddStaticImage((int)ControlId.MOVING_IMAGE, gridControls, 
                new Image[] { imgJoystickHandle }, new Point(940, 211));

            Controls.AddKeyBoard((int)ControlId.KEYBOARD, gridKeyboard, 
                new Image[] { imgWhiteKey, imgBlackKey, imgWhiteKeyDown, imgBlackKeyDown }, new Point(144, 560), 36, 72);
            ...
            midiMenu = Controls.AddPopupMenuButton((int)ControlId.POPUP_MENU, gridControls, 
            ...
            midiInMenu = midiMenu.AddMenuItem(menu, menuItem++, 
                new Image[] { imgPopupMenuButtonBackground, imgImageButtonHover }, ControlBase.PopupMenuButtonStyle.MENU, 
                ...
                "MIDI in devices", 20, false, ControlBase.ControlTextWeight.BOLD, ControlBase.ControlTextAlignment.CENTER, 1.0, 0.0, 0.0,
                new SolidColorBrush(Color.FromArgb(255, 255, 255, 255)), new SolidColorBrush(Color.FromArgb(255, 255, 255, 255)));
            midiOutMenu = midiMenu.AddMenuItem(menu, menuItem++, new Image[] { imgPopupMenuButtonBackground, imgImageButtonHover },
                ControlBase.PopupMenuButtonStyle.MENU, new ControlBase.PointerButton[] { ControlBase.PointerButton.LEFT, ControlBase.PointerButton.RIGHT, ControlBase.PointerButton.OTHER }, 
                "MIDI out devices", 20, false, ControlBase.ControlTextWeight.BOLD, ControlBase.ControlTextAlignment.CENTER, 1.0, 0.0, 0.0,
                new SolidColorBrush(Color.FromArgb(255, 255, 255, 255)), new SolidColorBrush(Color.FromArgb(255, 255, 255, 255)));
            ...
            {
                midiInMenu.AddMenuItem(menu, menuItem++, new Image[] { imgPopupMenuButtonBackground, imgImageButtonHover },
                    ControlBase.PopupMenuButtonStyle.MENU, new ControlBase.PointerButton[] { ControlBase.PointerButton.LEFT },
                    midiInPortName.ToString(), 20, false, ControlBase.ControlTextWeight.BOLD, ControlBase.ControlTextAlignment.LEFT,
                    1.0, 0.0, 0.0);
            }
            ...
            for (int i = 0; i < 16; i++)
            {
                midiInMenu.AddMenuItem(menu, menuItem++, new Image[] { imgPopupMenuButtonBackground, imgImageButtonHover }, 
                    ControlBase.PopupMenuButtonStyle.MENU, new ControlBase.PointerButton[] { ControlBase.PointerButton.LEFT },
                    "In ch " + (i + 1).ToString(), 20, false, ControlBase.ControlTextWeight.BOLD, ControlBase.ControlTextAlignment.LEFT,
                    1.0, 0.0, 0.0);
            }
            ...
            {
                midiOutMenu.AddMenuItem(menu, menuItem++, new Image[] { imgPopupMenuButtonBackground, imgImageButtonHover }, 
                    ControlBase.PopupMenuButtonStyle.MENU, new ControlBase.PointerButton[] { ControlBase.PointerButton.LEFT, ControlBase.PointerButton.OTHER }, 
                    midiOutPortName.ToString(), 20, false, ControlBase.ControlTextWeight.BOLD, ControlBase.ControlTextAlignment.LEFT,
                    1.0, 0.0, 0.0);
            }
            ...
            for (int i = 0; i < 16; i++)
            {
                midiOutMenu.AddMenuItem(menu, menuItem++, new Image[] { imgPopupMenuButtonBackground, imgImageButtonHover }, ControlBase.PopupMenuButtonStyle.MENU,
                    new ControlBase.PointerButton[] { ControlBase.PointerButton.LEFT }, "Out ch " + (i + 1).ToString(), 20, false, ControlBase.ControlTextWeight.BOLD, ControlBase.ControlTextAlignment.LEFT);
            }
        ...
        private void imgClickArea_PointerMoved(object sender, PointerRoutedEventArgs e)
        {
            if (initDone && Controls != null)
            {
                ...
                ((Label)Controls.ControlsList[(Int32)ControlId.LABEL]).TextBlock.Text = Controls.PointerPosition.ToString();
                foreach (object control in Controls.ControlsList)
                {
                    if (((ControlBase)control).IsSelected)
                    {
                        ((Label)Controls.ControlsList[(Int32)ControlId.LABEL]).TextBlock.Text =
                            ...
                            + ") (" + Math.Truncate(Controls.PointerPosition.X).ToString() + "," + Math.Truncate(Controls.PointerPosition.Y).ToString()
                            + ")";
                    }
                }
                            ...
                            if (((ControlBase)control).IsSelected)
                            {
                                switch (((ControlBase)control).Id)
                                {
                                    ...
                                    case (Int32)ControlId.JOYSTICK:
                                        ...
                                        ((StaticImage)Controls.ControlsList[(int)ControlId.MOVING_IMAGE]).
                                            MoveTo(new Point(
                                            ((Joystick)Controls.ControlsList[(Int32)ControlId.JOYSTICK]).ValueX + 940,
                                            211 - ((Joystick)Controls.ControlsList[(Int32)ControlId.JOYSTICK]).ValueY));
                                        break;
                                }
                            }
                        }
        ...
        private void MidiInPort_MessageReceived(MidiInPort sender, MidiMessageReceivedEventArgs args)
        {
            ...
            else if (args.Message.Type == MidiMessageType.NoteOff)
            {
                if (((PopupMenuButton)Controls.ControlsList[(int)ControlId.POPUP_MENU]).IsOn)
                {
                    int portIndex = ((PopupMenuButton)Controls.ControlsList[(int)ControlId.POPUP_MENU]).Children[0][0].SelectedIndex;
                    int channel = ((PopupMenuButton)Controls.ControlsList[(int)ControlId.POPUP_MENU]).Children[0][1].SelectedIndex;
                    if (portIndex > -1)
                    {
        ...
        private void Keyboard_PointerPressed(object sender, PointerRoutedEventArgs e)
        {
            ...
            if (((PopupMenuButton)Controls.ControlsList[(int)ControlId.POPUP_MENU]).IsOn)
            {
                int portIndex = ((PopupMenuButton)Controls.ControlsList[(int)ControlId.POPUP_MENU]).Children[0][1].SelectedIndex;
                if (portIndex > -1)
                {
